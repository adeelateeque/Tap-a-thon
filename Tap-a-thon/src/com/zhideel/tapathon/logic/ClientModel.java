...
public class ClientModel implements BusManager {
	 ...
	 */
	@Subscribe
	public void allIn(ClientModelEvent.AllInEvent event) {
	 ...
	 */
	@Subscribe
	public void blind(ClientModelEvent.BlindEvent event) {
		...
		TokenType tokenType;
		if (event.getBlindType() == ClientModelEvent.BlindEvent.BlindType.SMALL_BLIND) {
			if (mIsDealer) {
	 ...
	 */
	@Subscribe
	public void bid(ClientModelEvent.BidEvent event) {
	 ...
	 */
	@Subscribe
	public void fold(ClientModelEvent.FoldEvent event) {
	 ...
	 */
	@Subscribe
	public void call(ClientModelEvent.CallEvent event) {
	 ...
	 */
	@Subscribe
	public void raise(ClientModelEvent.RaiseEvent event) {
	 ...
	 */
	@Subscribe
	public void check(ClientModelEvent.CheckEvent event) {
	 ...
	 */
	@Subscribe
	public void cards(ClientModelEvent.CardsEvent event) {
	 ...
	 */
	@Subscribe
	public void sit(ClientModelEvent.SitEvent event) {
	 ...
	 */
	@Subscribe
	public void stand(ClientModelEvent.StandEvent event) {
		if (hasCards()) {
			final ChordMessage message = ChordMessage.obtainMessage(MessageType.FOLD);
			mBus.post(message);
		}
	 ...
	 */
	@Subscribe
	public void dealer(ClientModelEvent.DealerEvent event) {
		mIsDealer = true;
	 ...
	 */
	@Subscribe
	public void yourTurn(ClientModelEvent.YourTurnEvent event) {
		mPreviousBidAmount = mBidAmount;
	 ...
	 */
	@Subscribe
	public void playerState(ClientModelEvent.PlayerStateEvent event) {
		mAmount = event.getAmount();
	 ...
	 */
	@Subscribe
	public void clearCards(ClientModelEvent.ClearCardsEvent event) {
		mCards = null;
