...
import com.zhideel.tapathon.utils.Const;
...
public class PokerTableView extends SurfaceView implements SurfaceHolder.Callback, BusManager {
	...
	/**
	 * Refreshes poker table displayed on the TV. Triggered by the {@link com.zhideel.tapathon.ui.PokerTableView.PokerTableEvent}.
	 * 
	 * @param event
