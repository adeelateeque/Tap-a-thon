...
import static com.zhideel.tapathon.utils.Preconditions.checkState;
...
import com.zhideel.tapathon.chord.GameChord.ServerDisconnectedEvent;
...
import com.zhideel.tapathon.logic.ClientModel.ClientModelEvent;
...
import com.zhideel.tapathon.logic.GameLogicController.StartGameEvent;
...
public class GameActivity extends Activity implements BusManager {
	 ...
	 */
	@Subscribe
	public void turnEnd(GameActivityEvent.TurnEndEvent event) {
		for (View v : mViews) {
			v.setEnabled(false);
		}
	}
	 ...
	 */
	@Subscribe
	public void yourTurn(GameActivityEvent.YourTurnEvent event) {
	 ...
	 */
	@Subscribe
	public void gameEnd(GameActivityEvent.GameEndEvent event) {
	 ...
	 */
	@Subscribe
	public void amount(GameActivityEvent.AmountEvent event) {
		final int amount = event.getAmount();
	...
	@Subscribe
	public void sit(GameActivityEvent.SitEvent event) {
	 ...
	 */
	@Subscribe
	public void stand(GameActivityEvent.StandEvent event) {
		for (View v : mViews) {
			v.setEnabled(false);
		}
	}
	 ...
	 */
	@Subscribe
	public void token(GameActivityEvent.TokenEvent event) {
		if (event.getTokenType() == GameActivityEvent.TokenEvent.TokenType.NONE) {
			mTokenView.setVisibility(View.INVISIBLE);
		} else {
	 ...
	 */
	@Subscribe
	public void cards(GameActivityEvent.CardsEvent event) {
	 ...
	 */
	@Subscribe
	public void tableFull(GameActivityEvent.TableFullEvent event) {
	...
	@Subscribe
	public void clearCards(GameActivityEvent.ClearCardsEvent event) {
		mFirstCardView.setBitmap(null);
		mSecondCardView.setBitmap(null);
	}

	@Subscribe
	public void onSittingPlayersCountChanged(GameActivityEvent.SittingPlayersChangedEvent event) {
	...
	/**
	 * Event posted through the {@link com.squareup.otto.Bus} that contains information relevant for the {@link com.zhideel.tapathon.ui.GameActivity}.
	 */
